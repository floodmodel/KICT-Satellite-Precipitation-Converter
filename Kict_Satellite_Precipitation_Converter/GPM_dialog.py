...
class GPMDialog(QtWidgets.QMainWindow, FORM_CLASS):
    ...
    def Setini(self):
        ...
        self.btn_bat_path.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_bat_path)
        )
        self.btn_bat_path_1.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_bat_path_1)
        )
        self.btn_bat_path_2.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_bat_path_2)
        )
        ...
        self.btn_Output_Folder_Convert.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_Output_Convert)
        )
        ...
        self.btn_kml_folder.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_KML_Image_path)
        )
        ...
        # Shape 파일 경로 받아 오기
        self.btn_shape_dialog.clicked.connect(
            lambda: self.Shape_Select(self.txt_Shape_path)
        )

        # 폴더 선택 다이얼로그
        self.btn_Output_Folder.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_output_clip)
        )
        ...
        self.btn_input_utm.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_input_utm)
        )
        self.btn_output_utm.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_output_utm)
        )
        ...
        self.cmb_resample_method.addItems(
            [
                "bilinear",
                "near",
                "cubic",
        ...
        self.btn_input_resample.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_input_resample)
        )
        self.btn_output_resample.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_output_resample)
        )
        ...
        self.btn_output_accum.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_output_accum)
        )
        ...
        self.btn_csv_csv.clicked.connect(
            lambda: self.Save_File_Dialog(self.txt_shp_field, "csv")
        )
        #         self.btn_raster_tiff.clicked.connect(self.raster_tiff_select)
        self.btn_raster_tiff.clicked.connect(
            lambda: self.Save_File_Dialog(self.txt_raster_tiff, "tif")
        )
        ...
        self.btn_input_Function.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_output_fun)
        )  # 폴더 선택으로 변경
        ...
        self.btn_input_asc.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_input_asc)
        )
        #             lambda: self.Select_File_Dialog(self.txt_input_asc))
        self.btn_output_asc.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_output_asc)
        )
        ...
        self.btn_inputSHP.clicked.connect(
            lambda: self.input_Ref_file(self.txt_inputSHP, "shp")
        )
        ...
        self.btn_Select_Covert_File.clicked.connect(
            lambda: self.input_Ref_file(self.txt_Convert_path, "csv")
        )
        ...
        self.btnOutputDialog.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txtOutputDataPath)
        )
        ...
        self.btn_csvRemove.clicked.connect(
            lambda: self.ReMove(self.lisw_Convert_file, self._CSV_filename)
        )
        ...
        self.btn_ASCremove.clicked.connect(
            lambda: self.ReMove(self.lisw_ASC, self._ASC_filename)
        )
        ...
        self.btn_inputSHP_CM.clicked.connect(
            lambda: self.input_Ref_file(self.txt_inputSHP_CM, "shp")
        )
        self.btn_Select_Covert_File_CM.clicked.connect(
            lambda: self.input_Ref_file(self.txt_Convert_path_CM, "csv")
        )
        ...
        self.btnOutputDialog_CM.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txtOutputDataPath_CM)
        )

        # 2020-09-10 박:
        self.btn_csvUp_CM.clicked.connect(
            lambda: self.MoveUp(self.lisw_Convert_file_CM)
        )
        self.btn_csvDown_CM.clicked.connect(
            lambda: self.MoveDown(self.lisw_Convert_file_CM)
        )
        self.btn_csvRemove_CM.clicked.connect(
            lambda: self.ReMove(self.lisw_Convert_file_CM, self._CSV_filename_CM)
        )
        ...
        self.btn_ASCremove_CM.clicked.connect(
            lambda: self.ReMove(self.lisw_ASC_CM, self._ASC_filename_CM)
        )

        # make image ====================================
        # 멀티 셀렉트 옵션
        self.cmb_symbol.addItems(
            ["Select_Symbol", "circle", "square", "triangle", "cross_fill"]
        )
        ...
        self.btn_select_save_path_imag.clicked.connect(
            lambda: self.saveFileDialog(self.txt_save_gif_path_imag, "GIF")
        )
        ...
        self.btn_output_png.clicked.connect(
            lambda: self.Select_Folder_Dialog(self.txt_output_png)
        )
        ...
        try:
            ...
            if self.lisw_ASC_CM.rowCount() != self.lisw_Convert_file_CM.rowCount():
                _util.MessageboxShowInfo(
                    "GPM NOTICE", "Number of CSV FILES and ASC FILES do not match."
                )
                return
            ...
            for i in range(self.lisw_ASC_CM.rowCount()):
                TIf_path = (
                    self.txt_Input_data_CM.text()
                    + "/"
                    + self.lisw_ASC_CM.item(i, 0).text()
                )
                CSV_path = self.lisw_Convert_file_CM.item(i, 0).text()
                CM_Method.cm_method(
                    TIf_path, dist, CSV_path, output_path, self.tbl_Result_CM
                )
                self.satellite_progressBar_CM.setValue(i + 1)
                QApplication.processEvents()
            if self.lisw_ASC_CM.rowCount() == self.tbl_Result_CM.rowCount():
                _util.MessageboxShowInfo(
                    "CM Module", "CM module work has been completed."
                )
    ...
    def File_dialog(self, type, txtbox):
        if type == "RASTER":
            self.select_raster = QFileDialog.getOpenFileName(
                self, "Select Raster file", "", "tif, TIF (*.tif)"
            )[0]
            txtbox.setText(str(self.select_raster))
        else:
            self.select_SHP = QFileDialog.getOpenFileName(
                self, "Select Shape file", "c://", "*.shp *.SHP"
            )[0]
    ...
    def Run_CM_Module(self):
        ...
        if _util.CheckFile(CM_Raster_path) and _util.CheckFile(CM_Shape_Path):
            ...
            _util.MessageboxShowError(
                "CM Module", "Please check the raster file or shape file path"
            )
    ...
    def zoomToSelected(self, layer):
        ...
        point1 = QgsMapToolEmitPoint(self.gpm_canvas).toMapCoordinates(
            layer, QgsPointXY(bfExtent.xMinimum(), bfExtent.yMinimum())
        )
        point2 = QgsMapToolEmitPoint(self.gpm_canvas).toMapCoordinates(
    ...
    def qTabBar(self):
        ...
        self.setStyleSheet(
            "QStackedWidget#stackedWidget{border: 1px solid; border-color: rgb(200, 200, 200);}"
        )
    ...
    def Shape_Select(self, txt):
        if txt.text() != "":
            fname = QFileDialog.getOpenFileName(
                self, "Open file", "", "Shape files (*.shp)"
            )
        else:
            # 초기경로 ==>  C:\ 경로
            fname = QFileDialog.getOpenFileName(
                self, "Open file", "c://", "Shape files (*.shp)"
            )
            ...
            if txt.text() == "":
                ...
                if type == "csv":
                    self.select_file = QFileDialog.getOpenFileName(
                        self, "Select csv file.", "c://", "*.csv *.CSV"
                    )[0]
                ...
                if type == "shp":
                    self.select_SHP = QFileDialog.getOpenFileName(
                        self, "Select Shape file", "", "*.shp *.SHP"
                    )[0]
                    txt.setText(str(self.select_SHP))
                if type == "csv":
                    self.select_file = QFileDialog.getOpenFileName(
    ...
    def Select_Folder_Dialog(self, txt):
        if txt.text() != "":
            ...
            Folder = str(
                QFileDialog.getExistingDirectory(self, "Select Directory", "c://")
            )

        if _util.CheckKorea(Folder) == True:
            _util.MessageboxShowError(
                "KICT Satellite Precipitation Converter",
                "Check Path, No use Korean.\nPlease use English.",
            )
            return
            ...
            if type == "asc":
                if txt.text() != "":
                    filename = QFileDialog.getSaveFileName(
                        self, "save file", "", filter="asc (*.asc *.)"
                    )
                else:
                    filename = QFileDialog.getSaveFileName(
                        self, "save file", "c://", filter="asc (*.asc *.)"
                    )
                txt.setText(str(filename[0]))
            elif type == "shp":
                if txt.text() != "":
                    filename = QFileDialog.getSaveFileName(
                        self, "save file", "", filter="shp (*.shp *.)"
                    )
                else:
                    filename = QFileDialog.getSaveFileName(
                        self, "save file", "c://", filter="shp (*.shp *.)"
                    )
                txt.setText(str(filename[0]))
            elif type == "csv":
                if txt.text() != "":
                    ...
                    filename = QFileDialog.getSaveFileName(
                        self, "save file", "c://", filter="csv (*.csv *.)"
                    )
                txt.setText(str(filename[0]))
            elif type == "tif":
                if txt.text() != "":
                    self.filename = QFileDialog.getOpenFileNames(
                        self, "Open file", "", "tif, TIF (*.tif)"
                    )
                #                     txt.setText(str(self.filename[0]))
                else:
                    self.filename = QFileDialog.getOpenFileNames(
                        self, "Open file", "c://", "tif, TIF (*.tif)"
                    )
            ...
            if txt.text() == "":
                file = str(
                    QFileDialog.getSaveFileName(
                        self, "Save Folder Path", "C://", ".tif"
                    )
                )
            else:
                file = str(
                    QFileDialog.getSaveFileName(self, "Save Folder Path", "", ".tif")
                )
            txt.setText(file)
        else:
            if txt.text() == "":
                file = QFileDialog.getSaveFileName(
                    self, "Save GIF Path", "C://", ".gif"
                )
            else:
    ...
    def read_Layer_Get_Noadta(self, ratserLayer):
        ...
        self.Projection = str(
            srs.GetAttrValue("authority", 0) + ":" + srs.GetAttrValue("authority", 1)
        )
    ...
    def ReMove(self, table, layers):
        ...
        result = QMessageBox.question(
            None, "Remove", mess, QMessageBox.Yes, QMessageBox.No
        )
        ...
        try:
            ...
            if type == "GPM":
                ...
                if userId == "" and userPw == "":
                    _util.MessageboxShowInfo(
                        "KICT Satellite Precipitation Converter",
                        "Make sure you enter your ID and password.",
                    )
                    return
                ...
                url = "ftp://{0}:{1}@hokusai.eorc.jaxa.jp/standard/v8/hourly/".format(
                    userId, userPw
                )
                # 네트워크 확인해서 접속 끊어 지면 다운로드 중지
                network_flag = _util.connected_to_internet(url)
                if not (network_flag):
                    ...
                    return
                datadownload = wget.GSMap_data_download(
                    userId,
                    userPw,
                    self.start_date_1.text(),
                    self.end_date_1.text(),
                    self.txt_bat_path_1.text(),
                    "",
                )
    ...
    def check_data_select(self):
        if self.rdo_GPM_convert.isChecked():
            ...
            self.select_convert_files("HDF5 (*V07B.HDF5)")
    ...
    def select_convert_files(self, format):
        try:
            ...
            self.tb_hdf5.setHorizontalHeaderLabels(["Layer List"])
            stylesheet = (
                "QHeaderView::section{Background-color:rgb(174, 182, 255, 100)}"
            )
            self.tb_hdf5.setStyleSheet(stylesheet)
            count = 0
        ...
        try:
            ...
            for idx in self.convert_list:
                ...
                try:
                    ...
                    gdal_translate = r'C:\Users\"{0}"\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\Kict_Satellite_Precipitation_Converter\Lib\gdal\gdal_translate.exe'.format(
                        username
                    )
                    #                     _util.MessageLogShowInfo("GPM",str(gdal_translate))
                    gdal_translate = gdal_translate.replace("\\", "/")
                    arg = 'HDF5:"{0}"://{1}/{2} -of GTiff "{3}"'.format(
                        str(datasouce).replace("\\", "/"),
        ...
        try:
            try:
                ...
                for file in list:
                    ...
                    arg = 'gdalwarp -overwrite -dstnodata -9999 -of GTiff  "{0}" "{1}" '.format(
                        pre_output, Output
                    )
                    ...
                    #                             Manual(Part install Mapwindow5).")
                        ...
                        _util.MessageboxShowInfo(
                            "KICT Satellite Precipitation Converter", str(e)
                        )
        ...
        try:
            ...
            for idx in self.convert_list:
                ...
                QgsMessageLog.logMessage(
                    str(os.path.splitext(datasouce)[0]), "CMORPH ASC"
                )

                try:
                    converter_exe = (
                        os.path.dirname(os.path.abspath(__file__))
                        + "/Lib/CMORPHToASC/HDC_Comp.exe"
                    )
    ...
    def select_Cilp_files(self):
        try:
            if str(self.tb_clip_Tiff.item(0, 0)) == "None":
                files = QFileDialog.getOpenFileNames(
                    self, "Open files", "C:\\", "tif (*.tif)"
                )[0]
            else:
                files = QFileDialog.getOpenFileNames(
                    self, "Open files", "", "tif (*.tif)"
                )[0]
        ...
        try:
            ...
            if self.rdo_Combo_Clip.isChecked():
                if self.cmb_clip_zone.currentIndex() == 0:
                    _util.MessageboxShowInfo(
                        "KICT Satellite Precipitation Converter", "Not selected Country"
                    )
    ...
    def cmb_clip_zone_apply(self):
        ...
        if len(self.tb_clip_Tiff.selectedIndexes()) > 0:
            # 선택된 레이어에만 적용되도록...
            clip_pro_count = 0
            self.clip_progressBar.setMaximum(
                len(self.tb_clip_Tiff.selectedIndexes()) - 1
            )
            if (
                os.path.exists(self.txt_output_clip.text() + "/" + str(area) + "/")
                == False
            ):
            ...
            for idx in self.tb_clip_Tiff.selectedIndexes():
                ...
                if self.convert_tiff != []:
                    ...
                    if "IMERG" in filename:
                        if (
                            os.path.exists(
                                self.txt_output_clip.text() + "/" + str(area) + "/GPM/"
                            )
                            == False
                        ):
                            gpm_folder = os.mkdir(
                    ...
                    try:
                        ...
                        if self.Nodata != "None":
                            arg = 'gdal_translate.exe -a_srs epsg:4326 -projwin {0} -a_nodata {1} -of GTiff "{2}" "{3}" '.format(
                                Clip_area, (self.Nodata), tif, Output
                            )
                        ...
                        #                             Output
                        if self.Nodata == "None":
                            arg = 'gdal_translate.exe -a_srs epsg:4326 -projwin {0} -a_nodata -9999  -of GTiff "{1}" "{2}"'.format(
                                Clip_area, tif, Output
                            )
            ...
            _util.MessageboxShowInfo(
                "KICT Satellite Precipitation Converter", "Not Selected Files."
            )
            return
    ...
    def Shape_Clip_apply(self):
        ...
        if len(self.tb_clip_Tiff.selectedIndexes()) > 0:
            ...
            if vector_polygon.geometryType() != QgsWkbTypes.PolygonGeometry:
                _util.MessageboxShowError(
                    "KICT Satellite Precipitation Converter",
                    "Check out the geometry type(polygon) in the shapefile.",
                )
                return
            ...
            for idx in self.tb_clip_Tiff.selectedIndexes():
                ...
                if self.convert_tiff != []:
                    ...
                    if "IMERG" in filename:
                        if (
                            os.path.exists(self.txt_output_clip.text() + "/shp/GPM/")
                            == False
                        ):
                            gpm_folder = os.mkdir(
                                self.txt_output_clip.text() + "/shp/GPM/"
                            )
                        Output = (
                            self.txt_output_clip.text()
                            + "/shp/GPM/"
                        ...
                        if (
                            os.path.exists(self.txt_output_clip.text() + "/shp/CMORPH/")
                            == False
                        ):
                            cmorph_folder = os.mkdir(
                                self.txt_output_clip.text() + "/shp/CMORPH/"
                            )
                        Output = (
                            self.txt_output_clip.text()
                            + "/shp/CMORPH/"
                        ...
                        if (
                            os.path.exists(self.txt_output_clip.text() + "/shp/GSMap/")
                            == False
                        ):
                            gsmap_folder = os.mkdir(
                                self.txt_output_clip.text() + "/shp/GSMap/"
                            )
                        Output = (
                            self.txt_output_clip.text()
                            + "/shp/GSMap/"
                    ...
                    try:
                        ...
                        arg = 'gdalwarp.exe -dstnodata {0} -s_srs {1} -t_srs {2} -q -cutline "{3}" -crop_to_cutline -tr {4} {5} -of GTiff "{6}" "{7}"'.format(
                            str(Nodata),
                            Projection,
                            Projection,
                            str(self.txt_Shape_path.text()),
                            str(clipWidth),
                            str(clipHeight),
                            tif,
                            Output,
    ...
    def user_clip_zone(self):
        ...
        if self.clip_x1.strip() == "":
            _util.MessageboxShowInfo(
                "KICT Satellite Precipitation Converter", "The clip zone is not set."
            )
        ...
        if self.isNumber(self.clip_x1) == False:
            _util.MessageboxShowInfo(
                "KICT Satellite Precipitation Converter", "Input number"
            )
            self.clip_1_x.setFocus()
            return
    ...
    def user_Clip_apply(self):
        ...
        Clip_area = "{0} {1} {2} {3}".format(
            str(self.clip_x1), str(self.clip_y1), str(self.clip_x2), str(self.clip_y2)
        )
        ...
        if len(self.tb_clip_Tiff.selectedIndexes()) > 0:
            ...
            #             folder =
            #             (self.txt_output_clip.text()+"/"+str(os.path.basename(self.txt_Shape_path.text()))+"/").replace("\\","/")
            folder = (self.txt_output_clip.text() + "/User_CLIP/").replace(
                "\\", "/"
            )  # 폴더명 임의 지정
            if os.path.exists(folder) == False:
                os.mkdir(folder)
            ...
            for idx in self.tb_clip_Tiff.selectedIndexes():
                ...
                if self.convert_tiff != []:
                    ...
                    if "IMERG" in filename:
                        if (
                            os.path.exists(
                                self.txt_output_clip.text() + "/User_CLIP/GPM/"
                            )
                            == False
                        ):
                            gpm_folder = os.mkdir(
                        ...
                        if (
                            os.path.exists(
                                self.txt_output_clip.text() + "/User_CLIP/CMORPH/"
                            )
                            == False
                        ):
                            cmorph_folder = os.mkdir(
                        ...
                        if (
                            os.path.exists(
                                self.txt_output_clip.text() + "/User_CLIP/GSMap/"
                            )
                            == False
                        ):
                            gsmap_folder = os.mkdir(
                    ...
                    try:
                        ...
                        #                             -projwin " +Clip_area + " -of GTiff " +tif+ " " +
                        #                             Output
                        arg = 'gdal_translate.exe -a_srs EPSG:4326 -projwin {0} -of GTiff "{1}" "{2}"'.format(
                            str(Clip_area), tif, Output
                        )
    ...
    def UTM_apply_Click(self):
        try:
            ...
            if str_Input_folder.strip() == "":
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter", "Select Directory"
                )
            ...
            if self.cmb_utm_target.currentIndex() == 0:
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter", "Not selected UTM"
                )
        ...
        try:
            ...
            for file in list:
                ...
                if "IMERG" in filename:
                    ...
                    Output = (
                        self.txt_output_utm.text() + "/GPM/" + filename + "_UTM.tif"
                    )

                elif "CMORPH" in filename:
                    if os.path.exists(self.txt_output_utm.text() + "/CMORPH/") == False:
                        cmorph_folder = os.mkdir(
                            self.txt_output_utm.text() + "/CMORPH/"
                        )
                    Output = (
                        self.txt_output_utm.text() + "/CMORPH/" + filename + "_UTM.tif"
                    )
                    ...
                    Output = (
                        self.txt_output_utm.text() + "/GSMap/" + filename + "_UTM.tif"
                    )
                    ...
                    Output = (
                        self.txt_output_utm.text() + "/UTM/" + filename + "_UTM.tif"
                    )

                #                 Output =self.txt_output_utm.text()+"/"+filename+"_UTM.tif"
                #
                arg = 'gdalwarp -overwrite -t_srs "{0}" -of GTiff "{1}" "{2}"'.format(
                    str(t_srs), file, Output
                )
                ...
                try:
                    ...
                    for file in Resample_folder_list:
                        ...
                        if "IMERG" in filename:
                            ...
                            Output = (
                                output_folder + "/GPM/" + filename + "_resample.tif"
                            )
                            ...
                            Output = (
                                output_folder + "/CMORPH/" + filename + "_resample.tif"
                            )
                            ...
                            Output = (
                                output_folder + "/GSMap/" + filename + "_resample.tif"
                            )
                        ...
                        arg = 'gdalwarp.exe -overwrite -s_srs {0} -t_srs {0} -r {1} -tr {2} {2} -of GTiff "{3}" "{4}"'.format(
                            str(self.Projection),
                            str(Method),
                            str(cellvalue),
                            str(file),
                    ...
                    if (len(InfoMsg)) != 0:
                        ...
                        )  # https://trac.osgeo.org/gdal/ticket/6742
    ...
    def Accum_Amount(self):
        try:
            ...
            for filelist in self.accum_list:
                ...
                if (
                    os.path.exists(self.txt_output_accum.text() + "/GPM/Amount")
                    == False
                ):
                    #                     print ("False")
    ...
    def accum_check_GSMap(self, list):
        try:
            ...
            # ============ 3h ===========
            if self.chk_Accum_3H.isChecked():
                GSMap_accum.accum_GSMap_3H(
                    self.txt_output_accum.text() + "/GSMap/", list
                )

            # ============ 6h ===========
            if self.chk_Accum_6H.isChecked():
                GSMap_accum.accum_GSMap_6H(
                    self.txt_output_accum.text() + "/GSMap/", list
                )

            # ============ 9h ===========
            if self.chk_Accum_9H.isChecked():
                GSMap_accum.accum_GSMap_9H(
                    self.txt_output_accum.text() + "/GSMap/", list
                )

            # ============ 12h ===========
            if self.chk_Accum_12H.isChecked():
                GSMap_accum.accum_GSMap_12H(
                    self.txt_output_accum.text() + "/GSMap/", list
                )

            # ============ 24h ===========
            if self.chk_Accum_24H.isChecked():
                GSMap_accum.accum_GSMap_24H(
                    self.txt_output_accum.text() + "/GSMap/", list
                )
        except Exception as e:
            _util.MessageboxShowInfo("GPM ACCUM HOUR", str(e))
    ...
    def CSV_apply_Click(self):
        try:
            ...
            if Input_file.strip() == "":
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter", "Select shp file "
                )
            ...
            if output_file.strip() == "":
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter", "Select Save file name "
                )
            ...
            try:
                ...
                # comboBox로 변경 시
                get_shape_fieldname = self.get_shape_coord(
                    (self.cmb_FieldAtt.currentText())
                )
                # lOG
    ...
    def get_shape_coord(self, txt):
        try:
            ...
            if (txt) not in (self.fieldNames):
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter", "No have FieldName"
                )
    ...
    def select_files_func(self):
        try:
            ...
            file_name = QFileDialog()
            file_name.setFileMode(QFileDialog.ExistingFiles)
            files = file_name.getOpenFileNamesAndFilter(
                self, "Open files", "C:\\", filter
            )
            FileList = files[0]
    ...
    def Fun_apply_Click(self):
        ...
        try:
            ...
            if self.txt_function_txt.text().strip() == "":
                _util.MessageboxShowError(
                    "KICT Satellite Precipitation Converter",
                    "The Operation you entered is incorrect or missing.",
                )
            ...
            for lyr in _layers:
                ...
                if lyr.type() == QgsMapLayer.RasterLayer:
                    ...
                    QgsMessageLog.logMessage(
                        str(lyr.dataProvider().dataSourceUri()), "GPM FUNCTION"
                    )
                    ...
                    call_arg = 'gdal_calc -A "{0}" --format GTiff --calc {1} --outfile "{2}" --NoDataValue {3}'.format(
                        fun_layer,
                        str(calculus2),
                        (path + "/" + str(lyr.name()) + "_function.tif"),
                        str(self.Nodata),
                    )
            ...
            _util.MessageboxShowInfo(
                "KICT Satellite Precipitation Converter", "Complete Raster Calculator."
            )
        except Exception as e:
            _util.MessageboxShowInfo("KICT Satellite Precipitation Converter", str(e))
    ...
    def Set_table_list_fun(self):
        ...
        for layer in _layers:
            ...
            if layer.type() == QgsMapLayer.RasterLayer:
                self.tlb_Function.insertRow(count)
                self.tlb_Function.setItem(
                    count, 0, QTableWidgetItem(layer.name() + "@1")
                )
    ...
    def ASC_apply_Click(self):
        try:
            ...
            if len(str_Input_file) == 0:
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter", "Select Tif file "
                )
            ...
            if os.path.isdir(self.txt_output_asc.text()) == False:
                _util.MessageboxShowError(
                    "GPM Make ASC", "This directory does not exist."
                )
            ...
            for asc in str_Input_file:
                ...
                if "CMORPH" in filename:
                    if os.path.exists(self.txt_output_asc.text() + "/CMORPH/") == False:
                        cmorph_folder = os.mkdir(
                            self.txt_output_asc.text() + "/CMORPH/"
                        )
                    output_filename = (
                        self.txt_output_asc.text()
                        + "/CMORPH/"
                ...
                arg = 'gdal_translate.exe -of AAIGrid -a_nodata {0} "{1}" "{2}"'.format(
                    self.Nodata, asc, output_filename
                )
    ...
    def Addlayer_OutputFile(self, outputpath):
        if os.path.isfile(outputpath):
            ...
            outputLayer = QgsRasterLayer(
                outputpath, (os.path.basename(outputpath)), "gdal"
            )
    ...
    def Select_ASC_event(self):
        ...
        if self.txt_Input_data.text() == "":
            self._ASC_filename = QFileDialog.getOpenFileNames(
                self, "Select Input ASC FILES", "c://", "*.asc *.ASC "
            )[0]
        else:
            self._ASC_filename = QFileDialog.getOpenFileNames(
                self, "Select Input ASC FILES", "", "*.asc *.ASC "
            )[0]
        ...
        if self._ASC_filename == []:
            ...
            for row in self._ASC_filename:
                ...
                self.lisw_ASC.setItem(
                    counts, 0, QTableWidgetItem(os.path.basename(row))
                )
    ...
    def Select_ASC_event_CM(self):
        try:
            ...
            if self.txt_Input_data_CM.text() == "":
                self._ASC_filename_CM = QFileDialog.getOpenFileNames(
                    self, "Select Input TIF FILES", "c://", "*.tif *.TIF "
                )[0]
            else:
                self._ASC_filename_CM = QFileDialog.getOpenFileNames(
                    self, "Select Input TIF FILES", "", "*.tif *.TIF "
                )[0]
            ...
            if self._ASC_filename_CM == []:
                ...
                # btnOpenDialog_Input에 선택한 파일들의 폴더 경로 넣기
                self.txt_Input_data_CM.setText(
                    os.path.dirname(self._ASC_filename_CM[0])
                )
                self.lisw_ASC_CM.setHorizontalHeaderLabels(["TIF"])
                # 선택된 파일들을 리스트 박스에 넣기
    ...
    def list_set_csv(self):
        ...
        try:
            for row in select_file:
                ...
                self.lisw_Convert_file.setItem(
                    counts, 0, QTableWidgetItem(os.path.basename(row))
                )
        except Exception as e:
            _util.MessageboxShowError("KICT Satellite Precipitation Converter", str(e))
        ...
        try:
            ...
            for raster in self._ASC_filename:
                ...
                for feat in features:
                    ...
                    feat2 = [
                        (str(feat_item).upper()) for feat_item in feat.attributes()
                    ]  # 여기서 사용자가 이제 철자를 완전 동일하지 않아도 모두 대문자화 시킴
                    #                     QgsMessageLog.logMessage(str(feat2),"GPM SHP for")
                    #                     if (txt) in (feat.attributes()):
                    if (txt.upper()) in feat2:
                        #                         QgsMessageLog.logMessage(str(txt.upper()),"GPM SHP")
                        ...
                        convert_crs_coord = (
                            str(pt).split("(")[1].split(")")[0].replace(" ", ",")
                        )
                        convert_crs.append(str(convert_crs_coord))
                    else:
                        pass
    ...
    def Convert_CSV_time(self):
        ...
        try:
            ...
            for row in reader_csv:
                ...
                create_csv = open(
                    self.select_file_path + "/{0}.csv".format(getfile), "w+"
                )
                self.CSV_filepath = []
                self.CSV_filepath.append(
                    self.select_file_path + "/{0}.csv".format(getfile)
                )
                ...
                for cols in row[i:]:
                    ...
                    if cols.strip() != "":
                        if (AreaCoord[j]) != []:
                            value = (
                                str(AreaCoord[j]).replace("['", "").replace("']", "")
                                + ","
                                + cols.strip()
                                + "\n"
                            )
    ...
    def Convert_CSV_time_CM(self):
        ...
        try:
            ...
            for row in reader_csv:
                ...
                self.lisw_Convert_file_CM.setItem(
                    counts,
                    0,
                    QTableWidgetItem(
                        self.select_file_path + "/{0}.csv".format(getfile)
    ...
    def Apply_all_correction(self):
        ...
        try:
            ...
            # 연세대 보정 알고리즘 코드로 진입
            run_correction = _corr.run_correction(
                self.txtOutputDataPath.text(),
                (self._ASC_filename),
                (self._CSV_filename),
                _decimal,
            ...
            if "Error" in str(run_correction):
                ...
                for count in range(len(self._CSV_filename)):
                    if self.chk_AddLayer.isChecked():
                        ...
                        self.Addlayer_OutputFile(
                            ...
                            + (
                                os.path.split(
                                    os.path.splitext(self._ASC_filename[count])[0]
                                )[1]
                            )
                            + ("_satellite_correction.asc")
                        )
                        _util.MessageLogShowInfo(
                            "SAT RESULT",
                            str(
                                self.txtOutputDataPath.text()
                                + "/"
                    ...
                    count = count + 1
                QgsMessageLog.logMessage(
                    "QGIS LOAD: " + "%s" % (time.time() - start_time_GPM),
                    "GPM Satellite",
                )
                # prj 파일 복사 넣기
                ...
                for ASC in range(len(self._ASC_filename)):
                    ...
                    SS = QTreeWidgetItem(
                        root, [value.replace(".asc", "_satellite_correction.asc")]
                    )
                    ...
                    i = i + 1
                QgsMessageLog.logMessage(
                    "Make PNG : " + "%s" % (time.time() - start_time_GPM),
                    "GPM Satellite",
                )
                ...
                # 기능이 모두 끝나면 메시지 알림
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter", str(run_correction)
                )
    ...
    def Find_ASC_CRS(self, dirpath):
        ...
        for prj in find_prj_list:
            ...
            for aaa in self._ASC_filename:
                if (
                    os.path.splitext(fileprj)[0]
                    == os.path.split(os.path.splitext(aaa)[0])[1]
                ):
                    shutil.copy(
                        prj,
                        self.txtOutputDataPath.text()
                        + "/"
                        + (fileprj).replace(".prj", "_satellite_correction.prj"),
                    )
    ...
    def make_png(self, asc_path, png_path):
        ...
        #         " " + png_path
        #         try:
        mycall = 'gdaldem.exe color-relief "{0}" "{1}" "{2}" -alpha'.format(
            asc_path, color_path, png_path
        )
    ...
    def btn_baseShp_change(self):
        ...
        try:
            self.shp_layer = QFileDialog.getOpenFileName(
                self, "Select Shape file", "c://", "*.shp *.SHP"
            )
            # 파일을 선택했다면~
            if self.shp_layer != "":
                self.txt_pngshp.setText(self.shp_layer)
                base_shp = QgsVectorLayer(
                    self.shp_layer,
                    (os.path.basename(self.shp_layer)).split(".shp")[0],
                    "ogr",
                )
            ...
            # 파일 선택을 안해서 여전히 빈 값이면~
                ...
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter", "No selected shape file."
                )
                return
    ...
    def btn_baseShp_polygon(self):
        ...
        try:
            if self.txt_pngshp_polygon.text() == "":
                self.shp_layer_polygon = QFileDialog.getOpenFileName(
                    self, "Select Shape file", "c:\\", "*.shp *.SHP"
                )[0]
            else:
                self.shp_layer_polygon = QFileDialog.getOpenFileName(
            ...
            if self.shp_layer_polygon != "":
                ...
                basepolygon = QgsVectorLayer(
                    self.shp_layer_polygon,
                    (os.path.basename(self.shp_layer_polygon)).split(".shp")[0],
                    "ogr",
                )
    ...
    def btn_baseShp_line(self):
        ...
        try:
            if self.txt_pngshp_line.text() == "":
                self.shp_layer_line = QFileDialog.getOpenFileName(
                    self, "Select Shape file", "c:\\", "*.shp *.SHP"
                )[0]
            else:
                self.shp_layer_line = QFileDialog.getOpenFileName(
            ...
            if self.shp_layer_line != "":
                ...
                baseLine = QgsVectorLayer(
                    self.shp_layer_line,
                    ((os.path.basename(self.shp_layer_line)).split(".shp")[0]),
                    "ogr",
                )
    ...
    def btn_baseShp_point(self):
        ...
        try:
            if self.txt_pngshp_point.text() == "":
                self.shp_layer_point = QFileDialog.getOpenFileName(
                    self, "Select Shape file", "c:\\", "*.shp *.SHP"
                )[0]
            else:
                self.shp_layer_point = QFileDialog.getOpenFileName(
            ...
            if self.shp_layer_point != "":
                ...
                basePoint = QgsVectorLayer(
                    self.shp_layer_point,
                    ((os.path.basename(self.shp_layer_point)).split(".shp")[0]),
                    "ogr",
                )
            #         QgsMapLayerRegistry.instance().addMapLayers([self.layer,
            #         base_map], False)
    ...
    def changeColor_Picker_polygon(self):
        color = QColorDialog.getColor(
            title="color box", options=QColorDialog.ShowAlphaChannel
        )
        ...
        if color.isValid():
            ...
            self.btn_changecolor_po.setStyleSheet(
                "background-color:{0};".format(colorName)
            )
            ...
            _util.MessageboxShowInfo(
                "KICT Satellite Precipitation Converter",
                "Defalut RGBA Value : 94,94,94,255",
            )
            # self.red = color.red()
            # self.green=color.green()
            # self.blue=color.blue()
    ...
    def changeColor_Picker_line(self):
        ...
        if color.isValid():
            ...
            colorName = color.name()
            self.btn_changecolor_pl.setStyleSheet(
                "background-color:{0};".format(colorName)
            )
    ...
    def changeColor_Picker_point(self):
        ...
        if color.isValid():
            ...
            colorName = color.name()
            self.btn_changecolor_point.setStyleSheet(
                "background-color:{0};".format(colorName)
            )
    ...
    def changeColor_polygon(self, polygon):
        ...
        if self.changeLabel == "change":
            props["color"] = "{0},{1},{2},{3}".format(
                self.red, self.green, self.blue, self.alpha
            )
            _util.MessageLogShowInfo(
                "color picker polygon",
                "{0},{1},{2},{3}".format(self.red, self.green, self.blue, self.alpha),
            )
        else:
    ...
    def changeColor_polyline(self, polyline):
        ...
        if self.changeLabel_pl == "change":
            props["line_color"] = "{0},{1},{2},{3}".format(
                self.red_pl, self.green_pl, self.blue_pl, self.alpha_pl
            )
            _util.MessageLogShowInfo(
                "color picker line",
                "{0},{1},{2},{3}".format(
    ...
    def changeColor_point(self, point):
        ...
        if self.changeLabel_po == "change":
            props["color"] = "{0},{1},{2},{3}".format(
                self.red_point, self.green_point, self.blue_point, self.alpha_point
            )
            _util.MessageLogShowInfo(
                "color picker point",
                "{0},{1},{2},{3}".format(
    ...
    def savePng_base(self, canvas, raster, polygon, line, point, saveName):
        ...
        self.gpm_canvas.setDestinationCrs(CRS)
        if (
            self.cmb_base_map.currentIndex() == 0
            or self.cmb_base_map.currentIndex() == 1
        ):
            self.basmap_layer = self.getBasemap("Google satellite")
        ...
        try:
            ...
            self.rasterLayer = QgsRasterLayer(
                raster, ((os.path.basename(raster)).split(".png")[0]), "gdal"
            )
            ...
            if polygon != "" and line == "" and point == "":
                baseLayer_polygon = QgsVectorLayer(
                    polygon, ((os.path.basename(polygon)).split(".shp")[0]), "ogr"
                )
                self.changeColor_polygon(baseLayer_polygon)

                self.layers = (
                    [self.rasterLayer] + [baseLayer_polygon] + [self.basmap_layer]
                )
            ...
            # SHP 3개
            if polygon != "" and line != "" and point != "":
                baseLayer_point = QgsVectorLayer(
                    point, (os.path.basename(point)).split(".shp")[0], "ogr"
                )
                self.changeColor_point(baseLayer_point)

                baseLayer_line = QgsVectorLayer(
                    line, (os.path.basename(line)).split(".shp")[0], "ogr"
                )
            ...
            if polygon == "" and line != "" and point == "":
                ...
                self.changeColor_polyline(baseLayer_line)
                self.layers = (
                    [self.rasterLayer] + [baseLayer_line] + [self.basmap_layer]
                )
                self.gpm_canvas.setLayers(self.layers)
                self.gpm_canvas.zoomToFullExtent()
                self.zoomToSelected(self.rasterLayer)
            ...
            if polygon == "" and line == "" and point != "":
                ...
                self.changeColor_point(baseLayer_point)
                self.gpm_canvas.setLayers(
                    [self.rasterLayer] + [baseLayer_point] + [self.basmap_layer]
                )
                self.layers = (
                    [self.rasterLayer] + [baseLayer_point] + [self.basmap_layer]
                )
            ...
            _util.MessageboxShowError(
                "KICT Satellite precipitation Converter", str(exc)
            )
            return
    ...
    def saveAScanvas(self, saveName):
        ...
        point1 = QgsMapToolEmitPoint(self.gpm_canvas).toMapCoordinates(
            self.rasterLayer, QgsPointXY(bfExtent.xMinimum(), bfExtent.yMinimum())
        )
        point2 = QgsMapToolEmitPoint(self.gpm_canvas).toMapCoordinates(
            self.rasterLayer, QgsPointXY(bfExtent.xMaximum(), bfExtent.yMaximum())
        )
        afExtent = QgsRectangle(point1, point2)
            ...
            if len(items) > 0:
                for i in list(items):
                    ...
                    if "IMERG" in asc_file:
                        if (
                            os.path.exists(self.txt_output_png.text() + "/GPM/")
                            == False
                        ):
                            gpm_folder = os.mkdir(self.txt_output_png.text() + "/GPM/")
                        png_name = (
                            self.txt_output_png.text()
                            + "/GPM/"
                            + asc_file.upper()
                            + ".PNG"
                        )
                    ...
                    if "CMORPH" in asc_file:
                        if (
                            os.path.exists(self.txt_output_png.text() + "/CMORPH/")
                            == False
                        ):
                            cmorph_folder = os.mkdir(
                                self.txt_output_png.text() + "/CMORPH/"
                            )
                        png_name = (
                            self.txt_output_png.text()
                            + "/CMORPH/"
                    ...
                    if "gsmap" in asc_file:
                        if (
                            os.path.exists(self.txt_output_png.text() + "/GSMap/")
                            == False
                        ):
                            gsmap_folder = os.mkdir(
                                self.txt_output_png.text() + "/GSMap/"
                            )
                        png_name = (
                            self.txt_output_png.text()
                            + "/GSMap/"
                    ...
                    if (
                        self.shp_layer_polygon != ""
                        or self.shp_layer_line != ""
                        or self.shp_layer_point != ""
                    ):
                        if "IMERG" in asc_file:
                            if (
                                os.path.exists(self.txt_output_png.text() + "/GPM/")
                        ...
                        sleep(0.5)
                        self.btl_png_list.addItem(
                            savePath
                        )  # 이게 결과 png 파일임.  이것만 들어가도록 처리..
                    else:
                        if "IMERG" in asc_file:
                            if (
                                os.path.exists(self.txt_output_png.text() + "/GPM/")
                        ...
                        saveImg = self.savePng_base(
                            self.gpm_canvas, png_name, "", "", "", savePath
                        )
                        QApplication.processEvents()
                        self.btl_png_list.addItem(png_name)
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation Converter",
                    "Image creation is complete. ",
                )
            else:
                _util.MessageboxShowError(
                    "KICT Satellite Precipitation Converter", "No ASC file selected."
                )
                return
    ...
    def Make_gif_user(self):
        try:
            ...
            if len(items) > 0:
                ...
                sleep(1)
                imageio.mimsave(
                    self.txt_save_gif_path_imag.text(),
                    img_list,
                    duration=(self.Interval_box_imag.value()),
                )
    ...
    def set_btn_icon(self):
        try:
            ...
            btn_apply_icon = (
                os.path.dirname(os.path.abspath(__file__)) + "/icon/bottom_arrow.png"
            )
        ...
        try:
            ...
            if len(self.convert_KML) > 0:
                ...
                for file in self.convert_KML:
                    ...
                    i = i + 1
                _util.MessageboxShowInfo(
                    "KICT Satellite Precipitation KML",
                    " KML file creation is complete.",
                )
        except Exception:
            _util.MessageboxShowError(
                "KICT Satellite Precipitation KML",
                " An error occurred while creating the KML file.",
            )
