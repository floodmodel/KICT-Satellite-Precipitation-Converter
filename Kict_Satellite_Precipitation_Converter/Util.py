...
class util:
    ...
    # 모듈 있는지 체크 후 없으면 설치, pip 사용 - 2022.12.28 조 추가(2024.05.22 오 수정)
    ...
    def connected_to_internet(self, url):
        try:
            # 2024.07 오 수정
    ...
    # http connected
    def connected_to_requests(self, url):
        try:
            requests.get(url)
            return True
